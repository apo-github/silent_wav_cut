...
iFile_path = iFilePath.replace(
    '\\', '/'
)  #iFilePath.replace("\", "\\")  #"input2.mp4#iFilePath #'C:\\Users\\fukic\\Documents\\syoriken\\python\\auto\\movie\\input2.mp4'  #iFilePath.replace("\", "\\")  #"input2.mp4"
iDir_path = iDirPath.replace(
    '\\', '/'
)  #'C:\\Users\\fukic\\Desktop'  #iDirPath.replace("\", "\\")  #current_dir
